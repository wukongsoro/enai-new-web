...
export const metadata: Metadata = {
  title: "AI Sales Automation Seattle | AI BDR Software WA | Enai.ai",
  description: "AI sales automation for Seattle tech companies. Scale with AI BDR agents. PT timezone support.",
  keywords: "AI sales automation Seattle, AI BDR Washington, Seattle sales software",
};
