...
import { Calendar, MapPin, Users, TrendingUp, Zap, Globe, ArrowRight, Building2, Target, ChartBar, CheckCircle2, DollarSign, Bot, Shield, Rocket, LineChart, Award, BrainCircuit, Briefcase, BadgeCheck, Lock, Database, Eye, Layers, Mail, Phone, MessageSquare } from "lucide-react";
...
export default function QatarSummit2026Content() {
    return (
        <>
            <script
